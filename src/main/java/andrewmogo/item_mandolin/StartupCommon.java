...
{
    public static Mandolin mandolin;  // this holds the unique instance of your block
    ...
    public static void preInitCommon()
    {
        ...
        //  +-----------------------+-----------------------+
        //
        mandolin = (Mandolin)(new Mandolin().setUnlocalizedName("mandolin_item_unlocalised_name"));
        mandolin.setRegistryName("mandolin_item_registry_name");
        ForgeRegistries.ITEMS.register(mandolin);
    }
